    ...
    class CadernoDeAtividades:GameState 
    {
        ...
        protected override void Initialize()
        {
            ...
            if (!initialized)
            {
                ...
                vQ2 = new Vector2(vQ1.X, vQ1.Y + 500);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (cor1 == Color.Black)
            {
                SpriteBatch.DrawString(arial, q1[Page] + alt1[Page], vQ1, cor1);
            }
            else
            {
            ...
            if (cor2 == Color.Black)
            {
                SpriteBatch.DrawString(arial, q2[Page] + alt2[Page], vQ2, cor2);
            }
            else
            {
            ...
            if (cor3 == Color.Black)
            {
                SpriteBatch.DrawString(arial, q3[Page] + alt3[Page], vQ3, cor3);
            }
            else
            {
            ...
            if (cor4 == Color.Black)
            {
                SpriteBatch.DrawString(arial, q4[Page] + alt4[Page], vQ4, cor4);
            }
            else
            {
